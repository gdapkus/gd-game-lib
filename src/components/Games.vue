  ...
  <v-app>
    <v-theme-provider theme="dark">
          <v-container>
            ...
            <v-dialog v-model="filtersDialog" width="360">
              <v-card>
                ...
                <v-card-text>
                  ...
                  >
                    <template #label>
                      <span class="text-subtitle-1 font-weight-bold">Player Count</span>
                    </template>
                    <v-radio
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: 'Rating', key: 'averageRating', width: '48px', align: 'center' },
        { title: 'Player Range', key: 'minPlayers', width: '48px', align: 'center' },
        { title: 'Best At', key: 'bestAtCount', width: '48px', align: 'center' },
        { title: 'Play Time', key: 'playingTime', width: '48px', align: 'center' },
        { title: 'Weight', key: 'averageWeight', width: '48px', align: 'center' },
      ],
    };
  },
